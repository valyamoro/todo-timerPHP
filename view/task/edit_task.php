ИЗМЕНИТЬ ПОСТ - <?php echo $_GET['slug']?>
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="new_slug" class="form-control" id="new_slug">
    </div>
    <div class="mb-3">
...
<!--Тут будет чекбокс-->
    ...
    <button type="submit" name="edit_post" value="1" class="btn btn-primary">Submit</button>
</form>
